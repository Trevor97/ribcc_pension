				    ...
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    ...
							    <div id="client_count" class="stats-figure"><?php countTotalClients($connect) ?></div>
						    </div><!--//app-card-body-->
						    <a class="app-card-link-mask" href="view_edit_clients.php"></a>
					    </div><!--//app-card-->
				    </div><!--//col-->
				    ...
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    ...
							    <div id="member_count" class="stats-figure"><?php countTotalMembers($connect) ?></div>
							    
						    </div><!--//app-card-body-->
						    <a class="app-card-link-mask" href="view_edit_members.php"></a>
					    </div><!--//app-card-->
				    </div><!--//col-->
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    <h4 class="stats-type mb-1">Total Dependants</h4>
							    <div id="dependant_count" class="stats-figure"><?php countTotalDependants($connect) ?></div>
						    </div><!--//app-card-body-->
						    <a class="app-card-link-mask" href="view_edit_dependants.php"></a>
					    </div><!--//app-card-->
				    </div><!--//col-->
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    <h4 class="stats-type mb-1">Expiring Policies</h4>
							    <div id="" class="stats-figure"><?php echo "NULL" ?></div>
						    </div><!--//app-card-body-->
